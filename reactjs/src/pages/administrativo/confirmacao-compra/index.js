...
export default function ConfirmacaoCompra () { 
    ...
    async function List() { 
     ...
     async function Confirm(id, number) { 
         let valueNumber = setValor(number)
         const resp = await api.putConfirmTicket(id, valueNumber);
         console.log(resp);  
